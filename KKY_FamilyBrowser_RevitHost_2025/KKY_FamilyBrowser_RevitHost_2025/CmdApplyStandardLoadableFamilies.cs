			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						ProjectStandardComparisonReport comparisonReport = ProjectStandardComparisonService.BuildReport(registration, registration.LastSnapshotPath, standardSnapshot, projectSnapshotPath, projectSnapshot, trackingCatalog);
						...
						}))
						{
							...
							ProjectTrackingCatalog refreshedTrackingCatalog = ProjectTrackingStampService.BuildCatalog(registration, standardSnapshot, postSnapshot);
							...
							ProjectStandardComparisonReport postComparisonReport = ProjectStandardComparisonService.BuildReport(registration, registration.LastSnapshotPath, standardSnapshot, postSnapshotPath, postSnapshot, refreshedTrackingCatalog);
