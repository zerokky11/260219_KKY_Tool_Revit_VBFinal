...
(function () {
  ...
  function styleBrowserSearch(tab) {
    ...
    var small = vp().w < 1500;
    var h = small ? 114 : 118;
    css(search, 'display:block !important;visibility:visible !important;position:absolute !important;left:0 !important;right:0 !important;top:0 !important;height:' + h + 'px !important;overflow-x:auto !important;overflow-y:hidden !important;background:#fff !important;border-bottom:1px solid #d8e4df !important;padding:8px 12px !important;box-sizing:border-box !important;z-index:5 !important;');
    return h;
  }
  ...
  function syncTableHeader(wrap) {
    ...
    for (var i = 0; i < ths.length; i++) {
      ...
      ths[i].style.backgroundColor = '#eef6f2';
      ths[i].style.boxShadow = top > 0 ? '0 1px 0 #cbded7' : 'none';
    }
  }
  ...
  function styleBrowserPane(pane, tab, searchH, statusH) {
    ...
    css(grid, 'display:block !important;visibility:visible !important;position:absolute !important;left:0 !important;right:0 !important;top:' + headH + 'px !important;bottom:0 !important;width:auto !important;height:auto !important;overflow:hidden !important;background:#fff !important;box-sizing:border-box !important;z-index:1 !important;');
    css(findClass(grid, 'family-tree-panel'), 'display:block !important;visibility:visible !important;position:absolute !important;left:0 !important;top:0 !important;bottom:0 !important;width:' + treeW + 'px !important;overflow:auto !important;background:#f7fbf9 !important;border-right:1px solid #d8e4df !important;padding:9px 8px !important;box-sizing:border-box !important;z-index:2 !important;');
    css(findClass(grid, 'family-list-panel'), 'display:block !important;visibility:visible !important;position:absolute !important;left:' + treeW + 'px !important;right:0 !important;top:0 !important;bottom:0 !important;overflow:hidden !important;background:#fff !important;box-sizing:border-box !important;z-index:1 !important;');
    ...
    for (var i = 0; i < divs.length; i++) {
      ...
      if (cls.indexOf(' tablewrap ') >= 0 || cls.indexOf(' family-tablewrap ') >= 0) {
        ...
        css(divs[i], 'display:block !important;visibility:visible !important;position:absolute !important;left:0 !important;right:0 !important;top:' + bodyTop + 'px !important;bottom:0 !important;overflow:auto !important;background:#fff !important;box-sizing:border-box !important;');
      }
    }
  ...
  function resetWorkflowFilters(tab) {
    if (isBrowser(tab)) return;
    currentFilter = 'All';
    advStatus = 'All';
    advGroup = 'All';
    advCategory = '';
